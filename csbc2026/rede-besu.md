# Construção de uma Rede Blockchain Permissionada com Hyperledger Besu

## Objetivo

Neste laboratório será construída uma rede blockchain permissionada utilizando Hyperledger Besu e QBFT.

> Espaço para imagem: Arquitetura da rede (3 organizações, 2 nós por organização)

---

# 1. Instalar Requisitos - Aplicativos de Suporte

```bash
sudo apt install -y zip unzip
```

<!-- > Espaço para imagem: Instalação concluída -->
...
> Espaço para imagem: Docker instalado
...
Para verificar se todos os pré-requisitos foram corretamente atendidos execute o script:​
